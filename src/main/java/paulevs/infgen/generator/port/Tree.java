...
public final class Tree
{
	...
	private void blockLine(IWorld world, int[] start, int[] end)
	{
		byte index1 = 0;
		byte index2 = 0;
	...
	private int getLineLength(IWorld world, int[] start, int[] end)
	{
		byte index1 = 0;
		byte index2 = 0;
	...
	public final boolean generate(IWorld world, Random random, int x, int y, int z)
	{
		maxHeight = 12;
